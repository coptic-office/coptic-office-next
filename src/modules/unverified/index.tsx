...
export default function Unverified({ lang }: { lang: string }) {
        ...
        <div className='w-full px-4 md:px-[70px] py-6 pb-10 md:py-10 bg-white flex flex-col gap-10 rounded-2xl -mt-[130px] md:-mt-[230px] border-x-[1px] border-solid border-[#E5EAF4] border-b-[1px] mb-[45px] md:mb-[14px]'>
          <div className='p-4  flex flex-col gap-3 items-center'>
            ...
            <p className='text-base text-center text-black'>
              {translate("locale.Unverified_Payment")}
            </p>
            <div className='gap-4 w-full justify-center mt-4 flex flex-col md:flex-row items-center'>
              <button
                ...
                className={`h-[55px] w-full md:w-[181px]   bg-THEME_PRIMARY_COLOR disabled:opacity-45 rounded-lg flex justify-center items-center  text-white font-medium text-base `}>
                {translate("locale.retry")}
              </button>
              <a
                href='tel:+201222 222 883'
                className={`h-[55px] w-full md:w-[181px]   bg-THEME_PRIMARY_COLOR disabled:opacity-45 rounded-lg flex justify-center items-center  text-white font-medium text-base `}>
                {translate("locale.Call_Us")}
              </a>
            </div>
          </div>
        </div>
