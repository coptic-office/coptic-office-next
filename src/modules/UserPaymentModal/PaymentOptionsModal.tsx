  ...
  return (
    <div className=' min-w-full '>
      ...
      <div className='w-full bg-white rounded-b-[4px] px-3  md:px-12  '>
        ...
        <div className=' h-[500px] overflow-scroll md:overflow-hidden md:h-auto  flex flex-col md:flex-row gap-7'>
        ...
        <div className='w-full flex justify-center'>
          {" "}
          <p className='my-6 md:my-10 text-[#74777F] text-lg w-full  md:w-1/2 text-center'>
