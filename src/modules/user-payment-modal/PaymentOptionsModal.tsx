...
export const PaymentOptionsModal = ({
  ...
  return (
    <div className=' min-w-full pt-5 '>
      <div className='h-10 md:h-[56px] rounded-t-[4px] bg-THEME_PRIMARY_COLOR px-6 py-4 flex flex-row justify-between items-center'>
      ...
      <div className='w-full bg-white rounded-b-[4px] px-3  md:px-12  '>
        <p className='text-center text-THEME_PRIMARY_COLOR text-xl md:text-[36px] font-semibold rtl:font-medium py-3  md:py-7'>
          {translate("locale.Payment_Methods")}
        </p>
        <div className=' h-[380px] overflow-scroll md:overflow-hidden md:h-auto  flex flex-col md:flex-row gap-5'>
